...
/* drag and drop */
	...
	{
		var data = { action: 'save-certificate', _wpnonce: COSCHOOL_CERTIFICATE._wpnonce, certificate: COSCHOOL_CERTIFICATE.certificate_id };
		...
		$.ajax({
			type: "POST",
			url: ajaxurl,//set your server side save script url
			data: data,
			cache: false,
