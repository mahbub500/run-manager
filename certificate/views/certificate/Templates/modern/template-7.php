...
<head>
	...
	<link rel="stylesheet" href="<?php echo $assets_url; ?>/css/template-7.css">
</head>
<body style="margin: 0;">
	<div id="certificate-wrapper" style="background-image: url('<?php echo $assets_url; ?>/img/template-7.png');">
